...
router.post("/createMenu",auth,upload.single("menuImage"),validate(createMenuSchema),restrictTo("staff"),menu.addItem);
router.get("/getAllItems",auth,restrictTo("staff"),menu.getAllItems);
router.patch("/updateMenu/:id",auth,upload.single("menuImage"),validate(createMenuSchema),restrictTo("staff"),menu.updateItem);
